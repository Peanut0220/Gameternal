...
if (mysqli_query($mysqli, $sql)) {
    echo "<script>alert('Ticket Information Successfully deleted! Redirecting to Member List..');window.location.href='adminTicket.php';</script>";
} else {
    echo "<script>alert('Ticket Information was not Successfully deleted. Redirecting to Member List..');window.location.href='adminTicket.php';</script>";
}
