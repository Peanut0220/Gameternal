...
if (mysqli_query($mysqli, $sql)) {
    echo "<script>alert('Event Successfully deleted! Redirecting to Admin Event..');window.location.href='adminEvent.php';</script>";
} else {
    echo "<script>alert('Event was not Successfully deleted. Redirecting to Admin Event..');window.location.href='adminEvent.php';</script>";
}
