...
//if there is no uploaded file
    ...
    if (empty($title_err) && empty($detail_err) && empty($date_err) && empty($game_err) && empty($fileUpload_err)) {
        ...
        if (mysqli_query($mysqli, $sql)) {
            echo "<script>alert('News Successfully updated! Redirecting to Admin News..');window.location.href='adminNews.php';</script>";
        } else {
            echo "<script>alert('News was not Successfully updated. Redirecting to Admin News..');window.location.href='adminNews.php';</script>";
        }
            ...
            <fieldset>
                ...
                <div class="add-announ">
                    ...
                    <div class="fileinput" >
                        ...
                        <input type="file" name="fileUpload" id="fileUpload" class="<?php echo (!empty($fileUpload_err)) ? 'is-invalid' : ''; ?>" value="<?= $fileUpload ?>"    >
                    </div>
