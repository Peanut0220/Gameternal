...
if (mysqli_query($mysqli, $sql)) {
    echo "<script>alert('Booking Successfully deleted! Redirecting to Booking List..');window.location.href='memberBookingList.php';</script>";
} else {
    echo "<script>alert('Booking was not Successfully deleted. Redirecting to Booking List..');window.location.href='memberBookingList.php';</script>";
}
