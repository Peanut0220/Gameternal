            ...
            <div class="table-container">
                <table>
                    ...
                    if (isset($_POST['submit-search'])) {
                        ...
                        $sql = "SELECT * FROM event
                                WHERE eventname LIKE '%$search%' OR
                                eventdate LIKE '%$search%' OR
                                eventdesc LIKE '%$search%' OR
                                maxperson LIKE '%$search%'";
                        $result = mysqli_query($mysqli, $sql);
                ...
                <div class="add-cancel">
                    <button type="button" class="cancel" onclick="location.href = 'memberEvent.php'">Back</button>
                </div>
            </div>
        </div>
