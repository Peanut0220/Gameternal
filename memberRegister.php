    ...
    if (empty($username_err) && empty($fullname_err) && empty($email_err) && empty($phoneno_err) && empty($password_err)) {
        ...
        if ($stmt = $mysqli->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                ...
                echo "<script>alert('Account Registered Successfully! Redirecting to Login Page..');window.location.href='memberLogin.php';</script>";
            } else {
                echo "Oops! Something went wrong. Please try again later.";
            }
...
<html>
    ...
    <body>
        ...
        ?>
        <div class="sentence">
            <h1>JOIN OUR SOCIETY NOW TO OBTAIN YOUR <br><span> ETERNAL </span>ACCOUNT </h1>
            <h3>Games, Tournaments, Accessories, Records and News are all over here on Gameternal. <br>Connect with us and we will build a stronger society of gamer for you.</h3>
        </div>
        <div class="right">
            <div class="logo2">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="signup_link">
                    Already have an Account? <a href="memberLogin.php">Back to Login</a>
                </div>
        </div>
