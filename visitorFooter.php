...
<footer>
    ...
    <ul class="list">
        <li>
            <a href="visitorHome.php">Home</a>
        </li>
        <li>
            <a href="visitorGames.php">Games</a>
        </li>
        <li>
            <a href="visitorAboutUs.php">About Us</a>
        </li>
        <li>
            <a href="visitorNews.php">News</a>
        </li>
        <li>
            <a href="visitorFaq.php">FAQs</a>
        </li>
    </ul>
    <p class="copyright">
